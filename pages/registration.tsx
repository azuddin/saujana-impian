  ...
  return (
    <>
      ...
      <Layout>
        <div className="flex flex-col items-end mb-16">
          ...
          <div className="space-y-3 w-full mb-10">
            <FormControl className="flex items-center">
              <Checkbox size="lg" spacing="1rem" colorScheme="orange">
                <Text fontWeight="light" fontSize="xl">
                  ...
                  consent to the processing of my Personal Data as described in
                  the notice.
                </Text>
              </Checkbox>
            </FormControl>
            ...
            <FormControl className="flex items-center">
              <Checkbox size="lg" spacing="1rem" colorScheme="orange">
                <Text fontWeight="light" fontSize="xl">
                  I would like to receive newsletter and updates from Seremban 2
                  and IJM Land Berhad.
                </Text>
              </Checkbox>
            </FormControl>
        ...
        <div className="grid grid-cols-4 gap-10 border-t border-yellow-800 pt-10">
          <div className="flex">
            <div className="w-52">
          ...
          <div className="flex flex-col space-y-5">
            <div className="">
              <Text fontWeight="semibold">Seremban Two Holdings Sdn Bhd</Text>
              <Text>(199501028262/357468-H)</Text>
            </div>
            <Text>PT 10786, Seremban 2, 70300 Seremban, Negeri Sembilan.</Text>
          </div>
          <div className="flex flex-col space-y-5">
            <Text fontWeight="semibold">Contacts</Text>
            <div className="">
              <Text>Email: sales.s2@ijm.com</Text>
              <Text>Phone: 1800 222 456</Text>
            </div>
          </div>
          ...
          <div className="col-span-4">
            ...
            <Text fontSize="sm" className="text-yellow-800">
      ...
      <div style={{ backgroundColor: "#3B3539" }}>
        <div className="container py-10 px-20 mx-auto text-white space-y-5">
          <Text fontSize="xs">
